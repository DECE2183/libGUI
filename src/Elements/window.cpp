...
Window::Window(iVector2 pos, iVector2 size, const char *header) : Section(pos, size),
...
{}
Window::Window(iVector2 pos, iVector2 size, GUIElement *parent, const char *header) : Section(pos, size, parent),
    _headerSection(iVector2(0, 0), iVector2(size.x, BASE_HEIGHT), DefaultWindowHeaderStyle),
    _headerLabel(iVector2(BASE_OFFSET, 0), iVector2(size.x, BASE_HEIGHT), _headerSection, header)
{}
Window::Window(iVector2 pos, iVector2 size, GUIElement &parent, const char *header) : Section(pos, size, &parent),
...
Window::Window(iVector2 pos, iVector2 size, StyleSheet *style, StyleSheet *headerStyle, const char *header) : Section(pos, size, style),
    _headerSection(iVector2(0, 0), iVector2(size.x, BASE_HEIGHT), headerStyle),
    _headerLabel(iVector2(BASE_OFFSET, 0), iVector2(size.x, BASE_HEIGHT), &_headerSection, headerStyle, header)
{}
Window::Window(iVector2 pos, iVector2 size, StyleSheet &style, StyleSheet &headerStyle, const char *header) : Section(pos, size, &style),
    _headerSection(iVector2(0, 0), iVector2(size.x, BASE_HEIGHT), headerStyle),
    _headerLabel(iVector2(BASE_OFFSET, 0), iVector2(size.x, BASE_HEIGHT), _headerSection, headerStyle, header)
{}
Window::Window(iVector2 pos, iVector2 size, GUIElement *parent, StyleSheet *style, StyleSheet *headerStyle, const char *header) : Section(pos, size, parent, style),
    _headerSection(iVector2(0, 0), iVector2(size.x, BASE_HEIGHT), headerStyle),
    _headerLabel(iVector2(BASE_OFFSET, 0), iVector2(size.x, BASE_HEIGHT),& _headerSection, headerStyle, header)
{}
Window::Window(iVector2 pos, iVector2 size, GUIElement &parent, StyleSheet &style, StyleSheet &headerStyle, const char *header) : Section(pos, size, &parent, &style),
...
Window::Window(const Window &from) : Section(from),
    ...
    _headerLabel(from._headerLabel.getPosition(), from._headerLabel.getSize(), &_headerSection, from._headerLabel.getStyle(), from._headerLabel.getPureText())
{}
